...
const services = [
  { title: 'Roof Replacement', desc: 'From aging shingle roofs in Garrison Heights to storm-battered homes near Eastwood, JW Roofing delivers full roof replacements built to stand up to Gastonia\'s unpredictable weather year after year.', icon: serviceIcons[0] },
  { title: 'Storm Damage Repair', desc: 'Gaston County sees its share of severe storms. When high winds or hail hit your roof, our crew responds fast with expert repairs and handles insurance claims so you don\'t have to.', icon: serviceIcons[1] },
  { title: 'Roof Inspections', desc: 'Whether you\'re buying a home off Franklin Boulevard or preparing for hurricane season, our thorough roof inspections give you an honest assessment with zero pressure.', icon: serviceIcons[2] },
  { title: 'Shingle & Metal Roofing', desc: 'Architectural shingles, standing seam metal, or classic three-tab -- we install the right roofing system for your Gastonia home\'s style and your budget.', icon: serviceIcons[3] },
  { title: 'Gutter Installation', desc: 'Protect your foundation from North Carolina\'s heavy rainfall. We install seamless gutters and gutter guards designed to keep your home\'s drainage working flawlessly.', icon: serviceIcons[4] },
  { title: 'Commercial Roofing', desc: 'Flat roofs, TPO membranes, and metal systems for Gastonia businesses along Franklin and New Hope Road. Minimal disruption, maximum durability for your commercial property.', icon: serviceIcons[5] },
];

const trustItems = [
  'Serving Gaston County Homeowners for Over 15 Years',
  'Licensed, Bonded & Fully Insured in North Carolina',
  'Rated 4.9 Stars Across 300+ Local Reviews',
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <p className="about-text" data-animate data-delay="2">
              {'JW Roofing & Associates was built on a simple idea: Gastonia homeowners deserve a roofer they can actually trust. From our home base right here in Gaston County, we\'ve earned our reputation one roof at a time -- showing up on time, delivering honest estimates, and standing behind every job with a warranty that means something. When your neighbors need a roofer, they call JW.'}
            </p>
